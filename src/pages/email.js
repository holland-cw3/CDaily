  ...
  return (
    <div className="flex justify-center">
      <div className="emailsignup flex justify-center">
        <form
          action="https://evanmasiello.com/cdaily/signup.php"
          target="_blank"
          method="POST"
        >
          <h1 className="text-4xl mb-15 font-bold text-[#7b9a6d]">
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col justify-center mt-10">
              <p className="text-xl">
                Too busy to check rates every day? No Worries! <br></br>Sign-Up
                for our weekly notifications to stay informed on the latest
                rates
              </p>
              <input
                type="email"
